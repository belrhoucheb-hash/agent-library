...
meta: 9 sep: zes templates goedgekeurd, SID's nog op Render; eerste Dependabot-alert
...
| Dependabot-alerts | aan sinds 7 sep; secret scanning en branch protection niet beschikbaar op het gratis plan, gitleaks in de gate dekt de secrets | GitHub | warn: eerste alert 7 sep, medium: @anthropic-ai/sdk 0.88.0 naar 0.91.1 (memory-tool, niet in gebruik) | bij de bump-PR |
