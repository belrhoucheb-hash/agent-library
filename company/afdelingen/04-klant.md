...
| her-uitnodiging wagenpark | chauffeurs op stap new of invited tonen als Uitgenodigd; knop per rij en per wagenpark stuurt de fleet_invite-template (24 uur cooldown, slot per fleet, 409 zolang de template geen SID heeft); stap new gaat in de webhook naar de wagenpark-welkom | Whatsapp-bot | own: live 4 sep; fleet_invite goedgekeurd 9 sep gezien, SID nog op Render | 7 dagen na de eerste ronde (E12) |
