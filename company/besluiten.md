...
1. Wekker: waarschijnlijk niet nodig, de instantie bleef wakker (bewijs 3 sep 20:00). Wél nodig als de verdenking klopt: WhatsApp-templates voor cron-berichten (statusrapport, weekbericht, maandagbericht), anders bereikt geen enkel proactief bericht een chauffeur die langer dan 24 uur stil is. Check Twilio-log na 4 sep 08:00.
